...
function sortProducts(criteria, array){
    ...
    }else if (criteria === ORDER_BY_PROD_POPU){
        result = array.sort(function(a, b) {
...
document.addEventListener("DOMContentLoaded", function(e){
    ...
    document.getElementById("sortByPopu").addEventListener("click", function(){
        sortAndShowProducts(ORDER_BY_PROD_POPU);
    });
